...
switch true do
{
	case (_group_player in group_1pl): {[player,"16aa_1pl_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_2pl): {[player,"16aa_2pl_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_3pl): {[player,"16aa_3pl_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_16csmr): {[player,"16aa_16csmr_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_jfist): {[player,"16aa_jfist_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_hq): {[player,"16aa_hq_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_itc): {[player,"16aa_itc_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_jhc): {[player,"16aa_jhc_dzf"] call BIS_fnc_setUnitInsignia;};
	case (_group_player in group_mi): {[player,"16aa_mi_dzf"] call BIS_fnc_setUnitInsignia;};
